...
SECRET_KEY = 'django-insecure-no29r7e23af(enta!e0-4r)duhsbyp2bggo7x_xdt*xfhxw^3^'
...
RECAPTCHA_PUBLIC_KEY = '6LfkplMrAAAAAGf1yIgCxo2dbFK7HbdwHz59oJnZ'
RECAPTCHA_PRIVATE_KEY = '6LfkplMrAAAAALATSM7FPekaA6Tw8mz8A4Cw_Wvl'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # also useful for static file serving
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': LOG_DIR / 'django.log',  # Use the LOG_DIR variable
        },
    },
    'loggers': {
        'django': {
